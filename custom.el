(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ace-window multi-web-mode php-mode use-package twittering-mode ace-jump-mode auto-complete autopair helm iy-go-to-char org-bullets multiple-cursors expand-region dash yasnippet))))
...
(custom-set-faces
 ...
 '(cursor ((t (:background "RoyalBlue4" :foreground "#151718"))))
